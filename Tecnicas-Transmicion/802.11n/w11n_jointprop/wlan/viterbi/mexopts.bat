...
rem ********************************************************************
rem Extra includes (for compiling Viterbi module)
rem ********************************************************************
set MATDspDir=C:\MATLAB7\toolbox\dspblks
set MATComDir=C:\MATLAB7\toolbox\commblks
set INCLUDE=%MATDspDir%\INCLUDE;%INCLUDE%
set INCLUDE=%MATComDir%\SIM\INCLUDE;%INCLUDE%
set INCLUDE=%MATComDir%\SIM\SFUN\INCLUDE;%INCLUDE%
set INCLUDE=%MATComDir%\SIM\SRC\HANDSHAKE\INCLUDE;%INCLUDE%
set INCLUDE=%MATComDir%\SIM\SRC\ALGORITHM\INCLUDE;%INCLUDE%
